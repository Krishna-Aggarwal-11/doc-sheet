                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span className="absolute bottom-2 text-[10px] text-neutral-500 translate-x-1//2 transform">
                        {marker / 10 + 1}
                      </span>
                    </>
                  )}
...
const Marker = ({
  ...
  return (
    <div
      className="absolute top-0 w-4 h-full cursor-ew-resize z-[5] grooup -ml-2"
